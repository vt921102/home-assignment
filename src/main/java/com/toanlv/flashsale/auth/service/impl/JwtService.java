...
public class JwtService implements IJwtService {
   ...
   *
   * <p>Claims: sub — userId identifier — email or phone role — USER or ADMIN iss — issuer from
   * config iat — issued at exp — expiry
   */
  @Override
  public String issueAccessToken(UUID userId, String identifier, String role) {
  ...
  public UUID extractUserId(String token) {
    var subject = jwtParser.parseSignedClaims(token).getPayload().getSubject();
