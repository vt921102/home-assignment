...
public class RefreshTokenService implements IRefreshTokenService {
  ...
  public String issue(UUID userId) {
    ...
    var expiry = Instant.now(clock).plus(properties.jwt().refreshTokenTtl());
   ...
   *
   * <p>Rotation detects token reuse: If the presented token is already revoked, an attacker has
