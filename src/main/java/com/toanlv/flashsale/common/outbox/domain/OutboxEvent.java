...
public class OutboxEvent {
    ...
    /**
     * Business event name.
     * Examples: "OTP_DISPATCH", "FLASH_SALE_PURCHASED", "PRODUCT_RESTOCKED"
     */
    @Column(name = "event_type", nullable = false, length = 50)
    private String eventType;

    /**
     * Domain entity type that owns this event.
     ...
     * Each handler knows the expected payload shape for its event_type.
     */
    ...
    /**
     * Earliest time this event can be retried.
     * Set to NOW() on creation and updated after each failed attempt
    ...
    /**
     * Schedule next retry using exponential backoff with a cap of 10 minutes.
     * Backoff: 2^retryCount seconds (2s, 4s, 8s, 16s, 32s → capped at 600s)
     */
