...
@Tag(name = "Flash Sale", description = "Browse and purchase flash sale items")
@RestController
...
public class FlashSaleController {
  ...
  @Operation(
      ...
      description =
          "Returns all products available in active "
  ...
  @Operation(
      ...
      description =
          "Purchases a flash sale item for the authenticated user. "
  ...
  public ResponseEntity<PurchaseResponse> purchase(
    ...
    var response = purchaseService.purchase(user.userId(), request.sessionItemId(), idempotencyKey);
