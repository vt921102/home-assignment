...
@Tag(name = "Admin — Inventory",
        description = "Inventory management and restocking")
@RestController
...
public class InventoryAdminController {
    ...
    public InventoryAdminController(InventorySyncService inventorySyncService) {
    ...
    public ResponseEntity<InventoryDto> getInventory(
        ...
        return ResponseEntity.ok(
                InventoryDto.from(inventorySyncService.getInventory(productId)));
    }

    @Operation(summary = "Restock a product",
            description = "Adds stock to a product's available quantity. "
    ...
    public ResponseEntity<InventoryDto> restock(
        ...
        return ResponseEntity.ok(
                InventoryDto.from(
                        inventorySyncService.adminRestock(
