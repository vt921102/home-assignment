...
@Table(
        ...
        indexes = {
                ...
                @Index(
                        name = "idx_order_items_source_ref",
                        columnList = "source_ref_id"
                )
        }
)
public class OrderItem {
     ...
     * Decoupled from Product entity — future name changes
     * do not affect order history.
     */
    ...
    /**
     * Reference to flash_sale_session_items.id for flash sale orders.
     * Nullable — regular orders do not have a source ref.
     */
