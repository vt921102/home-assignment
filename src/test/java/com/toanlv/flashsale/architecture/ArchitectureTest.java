...
class ArchitectureTest {
  ...
  static final ArchRule auth_does_not_depend_on_domain_packages =
      noClasses()
          ...
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("com.toanlv.flashsale.flashsale..", "..inventory..", "..order..")
  ...
  static final ArchRule product_does_not_depend_on_flashsale_or_order =
      noClasses()
          ...
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("com.toanlv.flashsale.flashsale..", "..order..")
  ...
  static final ArchRule services_reside_in_service_or_worker_package =
      classes()
          ...
          .should()
          .resideInAnyPackage("..service..", "..strategy..", "..outbox..")
